...
export const categoryReducer = (state = INITIALSTATE, action) => {
  switch (action.type) {
    ...
    //////////////////UPDATE CATEGORY //////////////////
    ////////////////////////////////////////////////////
    case updateCategoryConstants.UPDATE_CATEGORY_REQUEST:
      return (state = {
        ...state,
        error: null,
        loading: true,
      });
    case updateCategoryConstants.UPDATE_CATEGORY_SUCCESS:
      return (state = {
        ...state,
        loading: false,
      });

    case updateCategoryConstants.UPDATE_CATEGORY_FAIL:
      return (state = {
        ...state,
        loading: false,
        error: action.payload,
    ...
    //////////////////DELETE CATEGORY //////////////////
    ////////////////////////////////////////////////////
    case deleteCategoryConstants.DELETE_CATEGORY_REQUEST:
      return (state = {
        ...state,
        error: null,
        loading: true,
    ...
    case deleteCategoryConstants.DELETE_CATEGORY_FAIL:
      return (state = {
        ...state,
        loading: false,
        error: action.payload,
